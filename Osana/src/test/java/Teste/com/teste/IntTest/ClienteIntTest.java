package Teste.com.teste.IntTest;
...
public class ClienteIntTest {
    ...
    public void shouldReturn201_WhenRegisteringClient() throws Exception {
    	Cliente cliente = new Cliente("{ \"name\": \"Ana Carolina\" }")
    ...
    public void verify_WhenCnpjIsValid() throws Exception {
        Cliente cliente = new Cliente(1L, "Ana Carolina", "true", "564654654654")
        .statusCode(HttpStatus.CREATED.value());
    }
    ...
    void shouldDeleteClientById() throws Exception {
        shouldCreateaNewClient();
        mockMvc.perform(MockMvcRequestBuilders
        .delete("/{id}", 1L))
        .andExpect(status().isNotFound());
    } private void shouldCreateaNewClient(){}
